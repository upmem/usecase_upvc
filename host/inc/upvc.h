...
#define NB_READS_BUFFER (128) /* To be increase if enough legacy memory available */
#define NB_DISPATCH_AND_ACC_BUFFER (32) /* To be increase if enough legacy memory available */
#define NB_ROUND (1)
